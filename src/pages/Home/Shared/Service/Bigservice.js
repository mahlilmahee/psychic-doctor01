...
const Bigservice = () => {
    return ( 
<div className="my-10 mx-auto grid  lg:grid-cols-2  gap-3  items-center justify-items-center p-10">
        ...
        {/* <div class=''>  */}
           <div class='w-2/4'> <h1 class='leading-loose text-3xl font-bold'>Have a treamtment</h1>
            ...
            <button className="btn my-3 btn-xs sm:btn-sm md:btn-md lg:btn-lg">Book now </button>
            {/* </div> */}
        </div>
        {/* </div> */}
